...
import order01 from '../../Images/resource/order01.png';
import order02 from '../../Images/resource/order02.png';
import order03 from '../../Images/resource/order03.png';
...
class Detail extends Component {
  ...
  pay = () => {
    Taro.navigateTo({
      url: "/pages/payOrder/pay?&outTradeNo=" + this.state.orderDetails.outTradeNo
    });
  }
            ...
            <View class="body">
              ...
              <View class="ODCont5">
                ...
                <View class="listBox flex-display" style="background-color:#fff">
                  ...
                  <View class="Text flex-flex1">商家配送</View>
                  <View class="Text flex-flex1">自提</View>
                </View>
              </View>
              ...
              <View class="ODCont5">
                ...
                <View class="listBox flex-display" style="background-color:#fff">
                  ...
                  <View class="Text flex-flex1" >待核销</View>
                  <View class="Text flex-flex1" >已核销</View>
                  <View class="Text flex-flex1" >退款中</View>
                  <View class="Text flex-flex1" >已退款</View>
                </View>
                <View class="listBox flex-display" style="background-color:#fff" >
                  <View class="name">退款原因</View>
                  <View class="Text flex-flex1">{"list.tuiContent"}</View>
                </View>
              </View>
              <View class="tip"></View>
            </View> : null
